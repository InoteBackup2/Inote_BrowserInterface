...
export const fr: Map<string, string> = new Map([
    ...
    [Msg.webpage_staticText.landing_page.SHORT_DESCRIPTION,"Inote offre une solution déportée avec laquelle vous pouvez à tout moment retrouver vos notes à l'aide d'une simple connexion"],
    [Msg.webpage_staticText.landing_page.QUICK_REGISTRATION,"Inscription rapide"],
    ...
    [Msg.webpage_staticText.signInForm.FORGOTTEN_PASSWORD,"Mot de passe oublié ?"],
    ...
    [Msg.webpage_staticText.footer.PRIVACY_AND_SECURITY,"Politique de confidentialité"],
    [Msg.webpage_staticText.footer.COOKIES,"Cookies"],
    [Msg.webpage_staticText.footer.FOLLOW_US_ON_SOCIAL_NETWORKS,"Suivez-nous sur les réseaux sociaux"],
    [Msg.webpage_staticText.footer.ALL_RIGTHS_RESERVED,"Tous droits réservés"],
    [Msg.webpage_staticText.protectedNavBar.PROFILE_MANAGEMENT,"Gestion du profil"],
